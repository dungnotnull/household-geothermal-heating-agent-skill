# test-scenarios.md — Skill 248: household-geothermal-heating
...
- **Input:** a typical Small-Scale Geothermal Heat Pump Engineering case with complete inputs.
...
- **Verdict target:** Optimal & Economical.
...
### Verdict coverage
Optimal & Economical, Conditional (loop space), Low Efficiency, Inconclusive.
